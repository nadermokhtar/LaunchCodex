...
ft9 = Action.create(body:"Plan for national Confrance",completed:false,  category: "task", priority: 1 , date_due: nil, user_id:1)
ft10= Action.create(body:"Talk to leo about new role on the Team",completed:false,  category: "task", priority: 2 , date_due: nil, user_id:1)
tt1 = Action.create(body:"Grab the show sheets from office",completed:false,  category: "task", priority: 3 , date_due: Date.today, user_id:1)
...
tt5 = Action.create(body:"Call past client Jake for birthday",completed:false,  category: "task", priority: 3 , date_due: Date.today, user_id:1)
...
ty1 = Action.create(body:"Call back guests from open house",completed:false,  category: "task", priority: 2 , date_due: Date.today-1, user_id:1)
...
ty4 = Action.create(body:"Set up marketing email",completed:false,  category: "task", priority: 2 , date_due: Date.today-1, user_id:1)
fe1 = Action.create(body:"Meeting Agent Joe to expand netwrok in north shore",completed:false,  category: "event", priority: 3 , date_due: Date.today+1, user_id:1)
fe2 = Action.create(body:"Meeting Agent Jill to expand netwrok in south shore",completed:false,  category: "event", priority: 0 , date_due: Date.today+2, user_id:1)
...
fe5 = Action.create(body:"Go to the luxury homes event",completed:false,  category: "event", priority: 0 , date_due: Date.today+5, user_id:1)
fe6 = Action.create(body:"Meet Coach for break fast",completed:false,  category: "event", priority: 2 , date_due: Date.today+6, user_id:1)
fe8 = Action.create(body:"Aniversery",completed:false,  category: "event", priority: 0 , date_due: Date.today+7, user_id:1)
fe9 = Action.create(body:"Roatary meeting",completed:false,  category: "event", priority: 2 , date_due: Date.today+8, user_id:1)
